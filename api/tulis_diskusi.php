<?php
    ...
    if ($postdata){
        ...
        $query1 = mysqli_query($connection, "BEGIN;");
				$query2 = mysqli_query($connection, "INSERT INTO artikel (id_kategori, id_topik, id_komoditas, judul_artikel, isi_artikel, tanggal, is_remove) VALUES (2, 1, 1, '$judul_artikel', '$isi_artikel', NOW(), 'N');");
